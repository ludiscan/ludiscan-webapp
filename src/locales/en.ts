...
export const en = {
  ...
  session: {
    ...
    embedUrlModalTitle: 'Generate Embed URL',
    embedUrlSessionLabel: 'Session',
    embedUrlExpirationLabel: 'Select Expiration Time',
    embedUrlPreset1h: '1 Hour',
    embedUrlPreset4h: '4 Hours',
    embedUrlPreset24h: '24 Hours',
